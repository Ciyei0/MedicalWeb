...
// Verificar que el id_medico existe en la URL
...
// Verificar que el id_medico corresponde al que está en la sesión
if ($id_medico != $_SESSION['id_medico']) {
    echo "No tienes permisos para acceder a estas citas.";
    exit();
}
?>
...
<?php
// Incluir el header
include '../../templates/header_medico.php';
